...
int main()
{
  ...
  value = servo360_getControlSys(12, S360_SETTING_KPV);
  print("KpV = %d\r", value);
  value = servo360_getControlSys(12, S360_SETTING_KIV);
  print("KiV = %d\r", value);
  value = servo360_getControlSys(12, S360_SETTING_KDV);
  print("KdV = %d\r", value);
  value = servo360_getControlSys(12, S360_SETTING_IV_MAX);
  print("I max V = %d\r", value);
  value = servo360_getControlSys(12, S360_SETTING_KPA);
  print("KpA = %d\r", value);
  value = servo360_getControlSys(12, S360_SETTING_KIA);
  print("KiA = %d\r", value);
  value = servo360_getControlSys(12, S360_SETTING_KDA);
  print("KdA = %d\r", value);
  value = servo360_getControlSys(12, S360_SETTING_IV_MAX);
